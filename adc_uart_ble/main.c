...
#define DEVICE_NAME                     "ADC_BLE"                               /**< Name of device. Will be included in the advertising data. */
...
void saadc_sampling_event_init(void)
{
    ...
    timer_config.bit_width = NRF_TIMER_BIT_WIDTH_32; // change the timer's width to 32- bit to hold large values for ticks 
...
//          bytes_to_send = sprintf(nus_string, "CH0: %d\r\n", p_event->data.done.p_buffer[0]);
         bytes_to_send = sprintf(nus_string, "CH0: " NRF_LOG_FLOAT_MARKER "\r\n", NRF_LOG_FLOAT((p_event->data.done.p_buffer[0]) * 3.6 / 4096));                     
